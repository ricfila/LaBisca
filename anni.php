...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col">
				<h1 class="mb-3"><strong>Riepilogo <?php echo $anno; ?></strong></h1>
				...
				$partita_max_data = $conn->query("SELECT Data FROM partite WHERE IdPartita = $partita_max;")->fetch_assoc()['Data'];
				$partita_min_data = $conn->query("SELECT Data FROM partite WHERE IdPartita = $partita_min;")->fetch_assoc()['Data'];
				?>

				<ul class="nav nav-tabs" role="tablist">
					<li class="nav-item" role="presentation">
						<a class="nav-link active" data-bs-toggle="tab" href="#riepilogo" aria-selected="true" role="tab"><i class="bi bi-clipboard-pulse"></i></a>
					</li>
					<li class="nav-item" role="presentation">
				...
				<div class="tab-content">
					<!-- RIEPILOGO -->
					<div class="tab-pane fade text-start py-3 active show" id="riepilogo" role="tabpanel">
						<div class="row">
