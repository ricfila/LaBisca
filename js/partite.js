...
function apri_racconto(i) {
	let ordinali = ['primo', 'secondo', 'terzo', 'quarto', 'quinto', 'sesto', 'settimo', 'ottavo', 'nono', 'decimo', 'undicesimo', 'dodicesimo', 'tredicesimo', 'quattordicesimo', 'quindicesimo', 'sedicesimo', 'diciassettesimo', 'diciottesimo', 'diciannovesimo', 'ventesimo', 'ventunesimo', 'ventiduesimo', 'ventitreesimo', 'ventiquattresimo', 'venticinquesimo', 'ventiseiesimo', 'ventisettesimo', 'ventottesimo', 'ventinovesimo', 'trentesimo', 'trentunesimo', 'trentaduesimo', 'trentatreesimo', 'trentaquattresimo', 'trenticinquesimo', 'trentaseiesimo', 'trentasettesimo', 'trentottesimo', 'trentanovesimo', 'quarantesimo', 'quarantunesimo', 'quarantaduesimo', 'quarantatreesimo', 'quarantaquattresimo', 'quarantacinquesimo', 'quarantaseiesimo', 'quarantasettesimo', 'quarantottesimo', 'quarantanovesimo', 'cinquantesimo', 'cinquantunesimo', 'cinquantaduesimo', 'cinquantatreesimo', 'cinquantaquattresimo', 'cinquantacinquesimo', 'cinquantaseiesimo', 'cinquantasettesimo', 'cinquantaottesimo', 'cinquantanovesimo', 'sessantesimo', 'sessantunesimo', 'sessantaduesimo', 'sessantatreesimo', 'sessantaquattresimo', 'sessantacinquesimo', 'sessantaseiesimo', 'sessantasettesimo', 'sessantaottesimo', 'sessantanovesimo', 'settantesimo', 'settantunesimo', 'settantaduesimo', 'settantatreesimo', 'settantaquattresimo', 'settantacinquesimo', 'settantaseiesimo', 'settantasettesimo', 'settantaottesimo', 'settantanovesimo', 'ottantesimo', 'ottantunesimo', 'ottantaduesimo', 'ottantatreesimo', 'ottantaquattresimo', 'ottantacinquesimo', 'ottantaseiesimo', 'ottantasettesimo', 'ottantaottesimo', 'ottantanovesimo', 'novantesimo', 'novantunesimo', 'novantaduesimo', 'novantatreesimo', 'novantaquattresimo', 'novantacinquesimo', 'novantaseiesimo', 'novantasettesimo', 'novantaottesimo', 'novantanovesimo', 'centesimo'];
	modal('Turno ' + ordinali[i], racconti[i], null);
	alias(nomealias);
}